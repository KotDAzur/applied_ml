...
# Définition des schémas pour les DataFrames
HANDS_SCHEMA = {
    "game_id": pl.Int64,
    "start_time": pl.Utf8,
    "end_time": pl.Utf8,
    "table_name": pl.Utf8,
    "small_blind": pl.Float64,
    "big_blind": pl.Float64,
    "game_type": pl.Utf8,
    "button_seat": pl.Int64,
    "num_players": pl.Int64,
    "board_flop": pl.Utf8,
    "board_turn": pl.Utf8,
    "board_river": pl.Utf8,
    "pot_total": pl.Float64,
    "rake": pl.Float64,
    "jp_fee": pl.Float64,
    "has_showdown": pl.Int64,
    "winner_count": pl.Int64
}
...
PLAYER_HANDS_SCHEMA = {
    ...
    "player": pl.Utf8,
    "seat": pl.Int64,
    "stack_start": pl.Float64,
    "is_button": pl.Int64,
    "is_small_blind": pl.Int64,
    "is_big_blind": pl.Int64,
    "hole_card_1": pl.Utf8,
    "hole_card_2": pl.Utf8,
    "cards_known": pl.Int64,
    "preflop_actions": pl.Utf8,
    "flop_actions": pl.Utf8,
    "turn_actions": pl.Utf8,
    "river_actions": pl.Utf8,
    "vpip": pl.Int64,
    "preflop_raise": pl.Int64,
    "saw_flop": pl.Int64,
    "saw_turn": pl.Int64,
    "saw_river": pl.Int64,
    "showdown": pl.Int64,
    "total_bet": pl.Float64,
    "total_collect": pl.Float64,
    "net_result": pl.Float64,
    "won_hand": pl.Int64
}
...
ACTIONS_SCHEMA = {
    ...
    "player": pl.Utf8,
    "street": pl.Utf8,
    "action_order": pl.Int64,
    "action_type": pl.Utf8,
    "amount": pl.Float64
}

# Templates pour initialiser les données
HAND_TEMPLATE = {
    "game_id": None,
    "start_time": None,
    "end_time": None,
...
def parse_single_hand(block):
    ...
    def ensure_player(name):
        if name not in players:
            players[name] = PLAYER_TEMPLATE.copy()
...
def parse_poker_txt(file_path):
    ...
    hands_df = pl.DataFrame(hands_rows, schema=HANDS_SCHEMA) if hands_rows else pl.DataFrame(schema=HANDS_SCHEMA)
    player_hands_df = pl.DataFrame(player_hands_rows, schema=PLAYER_HANDS_SCHEMA) if player_hands_rows else pl.DataFrame(schema=PLAYER_HANDS_SCHEMA)
    actions_df = pl.DataFrame(actions_rows, schema=ACTIONS_SCHEMA) if actions_rows else pl.DataFrame(schema=ACTIONS_SCHEMA)
